...
| File | Purpose |
|------|---------|
| `download-dispatch.fibery.txt` | Exact text of the **Send Email → Message** field in the "undersight download dispatch" automation (CMS/Website Leads → trigger: entity created). Zero-indentation Fibery/EJS format. |
